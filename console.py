...
class FlappyBirdEnv(gym.Env):
    def __init__(self, config_file_path: str = None,
        ...
        self.pipe_attributes = config['pipe_attributes']
        self.gravity = config['gravity']
        self.jump_strength = config['jump_strength']
        self.bird_img_obj = pygame.image.load(config['bird_img_path'])
        self.pipe_frequency = config['pipe_attributes']['pipe_frequency']
        self.colors = config['colors']
        self.pipe_speed = config['pipe_speed']
        self.frame_rate = config['frame_rate']
        self.minimum_action_gap = config['minimum_action_gap']
        ...
        self.game_length = game_length if game_length is not None else config['game_length']
